...
def makequads1(starlist, n=7, s=0, d=50.0, verbose=False):
	"""
...
def makequads2(starlist, f=5.0, n=6, s=0, d=50.0, verbose=False):
	"""
...
def removeduplicates(quadlist, verbose=False):
	"""
...
def proposecands(uknquadlist, refquadlist, n=5, verbose=False):
	"""
