...
def readsexcat(sexcat, hdu=0, verbose=False, maxflag = 3, posflux = True, minfwhm=1.0, propfields=[]):
	"""
...
def fitstars(uknstars, refstars, verbose=False):
	"""
...
# 	def teststars(self, uknstars, refstars, r=5.0, verbose=False):
# 		"""
...
# 		
# 		
# 	def refinestars(self, uknstars, refstars, r=5.0, verbose=False):
# 		"""
...
def identify(uknstars, refstars, trans=None, r=5.0, verbose=False, getstars=False):
	"""
	Allows to:
...
# 
# 
# def findtrans(preciserefmanstars, autostars, scalingratio = 1.0, tolerance = 2.0, minnbrstars = 5, mindist = 100.0, nref = 10, nauto = 30, verbose=False):
# 	
# 	"""
