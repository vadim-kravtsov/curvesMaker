...
class ImgCat:
	...
	def makecat(self, rerun=True, keepcat=False, verbose=False, polarMode=None):
	...
	def makestarlist(self, skipsaturated=False, n=200, verbose=False):
		if self.cat:
			if skipsaturated:
				maxflag = 3
			else:
	...
	def makemorequads(self, verbose=False):
		"""
	...
	def showstars(self, verbose=False):
		"""
	...
	def showquads(self, show=False, flux=True, verbose=False):
		"""
